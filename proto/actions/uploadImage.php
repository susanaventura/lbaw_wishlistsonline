...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
  ...
  if(!isset($_GET['type'])){
    die('Type of image is missing, please contact support!'); // output error when above checks fail.
  }
  
  if( $_GET['type'] == 'wishlistItem' ){
    $destination_folder = $destination_folder . 'wishlistItems/';
  } else if( $_GET['type'] == 'profile' ){
    $destination_folder = $destination_folder . 'profileImages/';
  } else {
    die('Type of image is incorrect, please contact support!'); // output error when above checks fail.
  }
